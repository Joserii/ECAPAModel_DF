...
parser.add_argument('--data_path', type=str, default='/lyxx/datasets/raw/ADD2023/train/wav/', help='长江时代数据集路径')
parser.add_argument('--save_path', type=str, default='/lyxx/datasets/raw/ADD2023/train/wav_vad/')
parser.add_argument('--sr', type=int, default=16000, help='采样率')
parser.add_argument('--device', type=str, default='cuda:0', help='显卡ID')
parser.add_argument('--vad_model', type=str, default='vad_16k_en_normal_crdnns', help='VAD模型')
...
parser.add_argument('--model_save_path', type=str, default='/ssd2/online/models/VAD', help='模型')
...
if __name__ == "__main__":
    ...
    phone_folders = sorted(os.listdir(args.data_path) )
    print(phone_folders)
    ...
    for phone_path in pbar:
        print(phone_path)
        total_length = get_info(os.path.join(args.data_path,phone_path), args.save_path)
